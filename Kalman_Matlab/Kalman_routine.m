...
%--Init
X0=zeros(4,1);  %6 si on prend en compte l'accélération
P0=eye(4);     %6 si on prend en compte l'accélération
Z0=zeros(8,1); %10 si on prend en compte l'accélération
Pred=zeros(N,4); %6 si on prend en compte l'accélération
Mesure=zeros(8,N); %10
