...
MODEL                = Kalman_boucle
MODULES              = Kalman_boucle_initialize.c Kalman_boucle_terminate.c Kalman_boucle.c inv.c rt_nonfinite.c rtGetNaN.c rtGetInf.c 
MAKEFILE             = Kalman_boucle_rtw.mk
MATLAB_ROOT          = C:\Program Files\MatLab 2012a
ALT_MATLAB_ROOT      = C:\PROGRA~1\MATLAB~1
MATLAB_BIN           = C:\Program Files\MatLab 2012a\bin
...
MODELLIB                  = Kalman_boucle.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Kalman_boucle_ref.rsp
MODELREF_INC_PATH         = 
RELATIVE_PATH_TO_ANCHOR   = U:\5SEC~1\PROJET~1\ARDRON~2\KALMAN~1
